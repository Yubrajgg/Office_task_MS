# Generated by Django 5.1.3 on 2025-02-14 08:39
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('user_type', models.CharField(choices=[('employer', 'Employer'), ('manager', 'Manager'), ('intern', 'Intern'), ('admin', 'Admin')], default='', max_length=10)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('status', models.CharField(choices=[('in_progress', 'In Progress'), ('achieved', 'Achieved'), ('missed', 'Missed')], max_length=100)),
                ('progress', models.PositiveIntegerField(default=0)),
                ('created_at', models.DateTimeField(auto_now_add=True, null=True)),
                ('deadline', models.DateTimeField(null=True)),
                ('completed', models.BooleanField(default=False, null=True)),
                ('assigned_to', models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, related_name='goals', to=settings.AUTH_USER_MODEL)),
            ],
        ),
        migrations.CreateModel(
